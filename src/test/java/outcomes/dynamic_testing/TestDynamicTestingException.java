...
class TestDynamicTestingExceptionServer {
...
class TestDynamicTestingExceptionClient {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
...
public class TestDynamicTestingException extends UserErrorTest<String> {
        ...
        return Arrays.asList(
            new TestCase<String>().setDynamicTesting(() -> {
                TestedProgram server = new TestedProgram(
                    TestDynamicTestingExceptionServer.class);

                TestedProgram client = new TestedProgram(
                    TestDynamicTestingExceptionClient.class);
