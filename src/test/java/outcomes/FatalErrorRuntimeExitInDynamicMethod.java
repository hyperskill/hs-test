...
class FatalErrorRuntimeExitInDynamicMethodMain {
...
public class FatalErrorRuntimeExitInDynamicMethod extends StageTest {
    @Rule
    ...
    CheckResult test1() {
        TestedProgram main = new TestedProgram(
            FatalErrorRuntimeExitInDynamicMethodMain.class);
        main.start();
        main.execute("123");
