...
public class TestDoubles {
    ...
    public void checkDoubles() {
        List<Double> doubles = expect("123 234.234 345.567").toContain(3).doubles();
    ...
    public void checkDoublesInText() {
        List<Double> doubles = expect("qweqw 123.76 dsjfdhasd234.09 345.98fgfgnfg").toContain(3).doubles();
    ...
    public void checkDoublesOnly() {
        List<Double> doubles = expect("123 234.234 345.567").toContain(3).doublesOnly();
    ...
    public void checkDoublesOnlyInTextFail() {
        try {
            expect("qweqw 123.76 dsjfdhasd234.09 345.98fgfgnfg").toContain(3).doublesOnly();
        } catch (PresentationError ex) {
            assertEquals(ex.getFeedbackText(),
    ...
    public void checkDoublesOnlyInTextFail2() {
        try {
            expect("1.0 2e3 -3 qweqw 123 dsjfdhasd234 345fgfgnfg").toContain(3).doublesOnly();
        } catch (PresentationError ex) {
            assertEquals(ex.getFeedbackText(),
                "The following output contains not only doubles (but also \"qweqw\"):\n" +
                    "\n" +
    ...
    public void checkDoublesOnlyWthDelim() {
        List<Double> doubles = expect("123.456  =234e3= 345e-1").toContain(3).doublesOnly("=");
    ...
    public void checkDoublesOnlyWthDelimFail() {
        try {
            expect("123.456  =234e3= 345e-1").toContain(1).doublesOnly("=");
        } catch (PresentationError ex) {
            assertEquals(ex.getFeedbackText(),
                "The following output contains wrong " +
